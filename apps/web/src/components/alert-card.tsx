...
export function AlertCard({
  ...
  return (
    <article
      ...
      className={cn(
        "alert-card flex items-center gap-5 overflow-hidden rounded-[1.5rem] border border-white/15 bg-[#251820]/95 p-5 text-[#fff8ed] shadow-[0_20px_60px_rgba(20,9,17,0.4)]",
